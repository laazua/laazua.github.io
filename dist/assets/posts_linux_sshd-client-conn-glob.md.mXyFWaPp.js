import{_ as i,o as a,c as n,ai as l}from"./chunks/framework.rV0OLpih.js";const y=JSON.parse('{"title":"ssh客户全局端配置","description":"","frontmatter":{"title":"ssh客户全局端配置","prev":{"text":"ssh客户端连接配置","link":"./ssh-client-conn"},"next":{"text":"SH CA使用示例教程","link":"./sshd-ca.md"}},"headers":[],"relativePath":"posts/linux/sshd-client-conn-glob.md","filePath":"posts/linux/sshd-client-conn-glob.md"}'),h={name:"posts/linux/sshd-client-conn-glob.md"};function p(k,s,t,e,F,r){return a(),n("div",null,[...s[0]||(s[0]=[l(`<h5 id="ssh客户端全局配置" tabindex="-1">ssh客户端全局配置 <a class="header-anchor" href="#ssh客户端全局配置" aria-label="Permalink to “ssh客户端全局配置”">​</a></h5><p>/etc/ssh/ssh_config - SSH 客户端配置<br> 作用：配置 SSH 客户端的行为，影响所有用户使用 ssh 命令时的默认设置<br> 一般在 /etc/ssh/ssh_config.d 目录下进行配置</p><ul><li><strong>配置选项</strong></li></ul><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 引入自定义配置</span></span>
