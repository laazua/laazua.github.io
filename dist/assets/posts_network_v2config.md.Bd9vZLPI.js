import{_ as i,o as a,c as n,ai as l,aq as p}from"./chunks/framework.rV0OLpih.js";const g=JSON.parse('{"title":"","description":"","frontmatter":{"prev":false,"next":{"text":"回到v2ray","link":"./v2ray"}},"headers":[],"relativePath":"posts/network/v2config.md","filePath":"posts/network/v2config.md"}'),t={name:"posts/network/v2config.md"};function h(k,s,e,F,E,r){return a(),n("div",null,[...s[0]||(s[0]=[l(`<h5 id="生成服务端节点配置" tabindex="-1">生成服务端节点配置 <a class="header-anchor" href="#生成服务端节点配置" aria-label="Permalink to “生成服务端节点配置”">​</a></h5><ul><li><strong>主机优化</strong></li></ul><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">########### vim /etc/sysctl.conf</span></span>
