import{_ as i,o as a,c as n,ai as l}from"./chunks/framework.rV0OLpih.js";const F=JSON.parse('{"title":"","description":"","frontmatter":{"prev":false,"next":false},"headers":[],"relativePath":"posts/linux/command.md","filePath":"posts/linux/command.md"}'),p={name:"posts/linux/command.md"};function h(t,s,k,e,r,g){return a(),n("div",null,[...s[0]||(s[0]=[l(`<h5 id="命令用法" tabindex="-1">命令用法 <a class="header-anchor" href="#命令用法" aria-label="Permalink to “命令用法”">​</a></h5><ul><li><strong>su&amp;&amp;sudo</strong></li></ul><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#### su 切换用户身份</span></span>
...
<span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;"># 测试: logger -t APP2 &quot;app2: 这是一条测试日志&quot;</span></span></code></pre></div>`,9)])])}const o=i(p,[["render",h]]);export{F as __pageData,o as default};
