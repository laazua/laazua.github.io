import{_ as i,o as a,c as n,ai as l}from"./chunks/framework.rV0OLpih.js";const g=JSON.parse('{"title":"ssh客户端连接配置","description":"","frontmatter":{"title":"ssh客户端连接配置","prev":{"text":"ssh服务端配置","link":"./ssh-server-conn"},"next":{"text":"ssh客户全局端配置","link":"./sshd-client-conn-glob"}},"headers":[],"relativePath":"posts/linux/sshd-client-conn.md","filePath":"posts/linux/sshd-client-conn.md"}'),h={name:"posts/linux/sshd-client-conn.md"};function p(k,s,t,e,r,F){return a(),n("div",null,[...s[0]||(s[0]=[l(`<h5 id="ssh客户端连接配置" tabindex="-1">ssh客户端连接配置 <a class="header-anchor" href="#ssh客户端连接配置" aria-label="Permalink to “ssh客户端连接配置”">​</a></h5><p>~/.ssh/config - SSH 用户客户端配置<br> 作用: 配置 SSH 客户端的连接参数，可以简化连接命令、管理多个 SSH 连接配置<br> 优先级高于 /etc/ssh/ssh_config</p><ul><li><strong>配置示例</strong></li></ul><div class="language-bash"><button title="Copy Code" class="copy"></button><span class="lang">bash</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">###### 主机配置 ######</span></span>
