import{_ as s,o as n,c as e,ai as p}from"./chunks/framework.rV0OLpih.js";const b=JSON.parse('{"title":"","description":"","frontmatter":{"prev":false,"next":false},"headers":[],"relativePath":"posts/middleware/nginx/domain-proxy.md","filePath":"posts/middleware/nginx/domain-proxy.md"}'),r={name:"posts/middleware/nginx/domain-proxy.md"};function i(t,a,o,l,c,d){return n(),e("div",null,[...a[0]||(a[0]=[p(`<h3 id="域名代理" tabindex="-1">域名代理 <a class="header-anchor" href="#域名代理" aria-label="Permalink to “域名代理”">​</a></h3><ul><li>说明</li></ul><pre>  访问 aaaaa.com/a/b/c 浏览器地址显示 aaaaa.com/a/b/c;
