import{_ as i,o as a,c as n,ai as l}from"./chunks/framework.rV0OLpih.js";const d=JSON.parse('{"title":"","description":"","frontmatter":{"prev":false,"next":{"text":"回到v2ray","link":"./v2ray"}},"headers":[],"relativePath":"posts/network/v2ray-conf.md","filePath":"posts/network/v2ray-conf.md"}'),p={name:"posts/network/v2ray-conf.md"};function h(k,s,t,e,F,E){return a(),n("div",null,[...s[0]||(s[0]=[l(`<h5 id="v2ray-配置生成" tabindex="-1">V2ray 配置生成 <a class="header-anchor" href="#v2ray-配置生成" aria-label="Permalink to “V2ray 配置生成”">​</a></h5><div class="language-shell"><button title="Copy Code" class="copy"></button><span class="lang">shell</span><pre class="shiki shiki-themes github-light github-dark" style="--shiki-light:#24292e;--shiki-dark:#e1e4e8;--shiki-light-bg:#fff;--shiki-dark-bg:#24292e;" tabindex="0" dir="ltr"><code><span class="line"><span style="--shiki-light:#6A737D;--shiki-dark:#6A737D;">#!/usr/bin/bash</span></span>
